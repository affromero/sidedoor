import { z } from 'zod';
import { readRequestBytes, RequestBodyTooLargeError } from '../../runtime/process/request';
import { AccessError, AccessService, newToken, isAccessError } from '../core/service';
import { PasskeyService } from '../passkey/passkeys';
import { PasskeyManagement } from '../passkey/passkey-management';
import { PASSWORD_INPUT_MAX_BYTES } from '../core/password';
import { hasAccessErrorBrand } from '../core/error-brand';
import { InvitationService } from '../admission/invitations';
import type { DeviceService } from '../admission/devices';
import type { HouseholdProfileService } from '../identity/profiles';
